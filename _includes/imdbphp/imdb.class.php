<?php
 ...
 /* $Id: imdb.class.php 330 2010-02-23 20:15:55Z izzy $ */
  ...
  * @version $Revision: 330 $ $Date: 2010-02-23 21:15:55 +0100 (Di, 23. Feb 2010) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 330 $');
    $this->setid($id);
  }
